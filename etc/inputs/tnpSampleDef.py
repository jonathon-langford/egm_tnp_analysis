...
eosLegacyReReco2016 = '/eos/cms/store/group/phys_egamma/tnpTuples/tomc/2020-05-14/2016/merged/'
...
eosUL2016pre  = '/eos/cms/store/group/phys_egamma/tnpTuples/rasharma/2021-02-10/UL2016preVFP/merged/'
eosUL2016post = '/eos/cms/store/group/phys_egamma/tnpTuples/rasharma/2021-02-10/UL2016postVFP/merged/'
...
LegacyReReco2016 = {
    ...
    'DY_madgraph' : tnpSample('DY_madgraph', 
                                        eosLegacyReReco2016 + 'DY_LO.root',
                                        isMC = True, nEvts =  -1 ),
    'DY_amcatnlo' : tnpSample('DY_amcatnlo', 
                                        eosLegacyReReco2016 + 'DY_NLO.root',
                                        isMC = True, nEvts =  -1 ),

    'data_Run2016B' : tnpSample('data_Run2016B' , eosLegacyReReco2016 + 'Run2016B.root' , lumi = 5.785 ),
    'data_Run2016C' : tnpSample('data_Run2016C' , eosLegacyReReco2016 + 'Run2016C.root' , lumi = 2.573 ),
    'data_Run2016D' : tnpSample('data_Run2016D' , eosLegacyReReco2016 + 'Run2016D.root' , lumi = 4.248 ),
    'data_Run2016E' : tnpSample('data_Run2016E' , eosLegacyReReco2016 + 'Run2016E.root' , lumi = 3.947 ),
    'data_Run2016F' : tnpSample('data_Run2016F' , eosLegacyReReco2016 + 'Run2016F.root' , lumi = 3.102 ),
    'data_Run2016G' : tnpSample('data_Run2016G' , eosLegacyReReco2016 + 'Run2016G.root' , lumi = 7.540 ),
    'data_Run2016H' : tnpSample('data_Run2016H' , eosLegacyReReco2016 + 'Run2016H.root' , lumi = 7.813 ),
...
UL2016_preVFP = {
    ### MiniAOD TnP for IDs scale factors
    'DY_madgraph'              : tnpSample('DY_madgraph',
                                       eosUL2016pre + 'DY_LO_L1matched.root',
                                       isMC = True, nEvts =  -1 ),
    'DY_amcatnloext'                 : tnpSample('DY_amcatnloext',
                                       eosUL2016pre + 'DY_NLO_L1matched.root',
                                       isMC = True, nEvts =  -1 ),


    'data_Run2016B' : tnpSample('data_Run2016B' , eosUL2016pre + 'Run2016B_L1matched.root' , lumi = 0.030493962),
    'data_Run2016C' : tnpSample('data_Run2016C' , eosUL2016pre + 'Run2016C_L1matched.root' , lumi = 2.64992914),
    'data_Run2016D' : tnpSample('data_Run2016D' , eosUL2016pre + 'Run2016D_L1matched.root' , lumi = 4.292865604),
    'data_Run2016E' : tnpSample('data_Run2016E' , eosUL2016pre + 'Run2016E_L1matched.root' , lumi = 4.185165152),
    'data_Run2016F' : tnpSample('data_Run2016F' , eosUL2016pre + 'Run2016F_L1matched.root' , lumi = 2.725508364),
    }

UL2016_postVFP = {
    ### MiniAOD TnP for IDs scale factors
    'DY_madgraph'              : tnpSample('DY_madgraph',
                                       eosUL2016post + 'DY_LO_L1matched.root',
                                       isMC = True, nEvts =  -1 ),
    'DY_amcatnloext'                 : tnpSample('DY_amcatnloext',
                                       eosUL2016post + 'DY_NLO_L1matched.root',
                                       isMC = True, nEvts =  -1 ),


    'data_Run2016F_postVFP' : tnpSample('data_Run2016F_postVFP' , eosUL2016post + 'Run2016F_L1merged.root' , lumi = 0.414987426),
    'data_Run2016G' : tnpSample('data_Run2016G' , eosUL2016post + 'Run2016G_L1matched.root' , lumi = 7.634508755),
    'data_Run2016H' : tnpSample('data_Run2016H' , eosUL2016post + 'Run2016H_L1matched.root' , lumi = 8.802242522),
    }
